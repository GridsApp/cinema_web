...
class ManagePoints extends Component
{
    ...
    public function searchByCard()
    {
        ...
        // try {
        $this->transactions = $this->cardRepository->getLoyaltyTransactions($user);
        // } catch (\Throwable $th) {
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $transaction = $this->cardRepository->createLoyaltyTransaction(
                $type,
                $this->form['amount'],
                $user,
    ...
    public function render()
    {
        ...
        return view('components.form.manage-points');
    }
}
