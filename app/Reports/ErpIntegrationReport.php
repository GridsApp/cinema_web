...
class ErpIntegrationReport extends DefaultReport
{
    ...
    //         $tax_amount = $seats_count != 0
    //             ? $this->taxCalculation($total_price)
    //             : 0;
    ...
    //         $footer['cost_of_sale'] += $data['cost_of_sale'];
    //         $footer['unit_cost'] += $data['unit_cost'];
    //         $footer['imtiyaz_discount'] += $data['imtiyaz_discount'];


    //         $data['unit_price'] = number_format($data['unit_price']);
    //         $data['total_price'] = number_format($data['total_price']);
    //         $data['tax_amount'] = number_format($data['tax_amount']);
    //         $data['cost_of_sale'] = number_format($data['cost_of_sale']);
    //         $data['unit_cost'] = number_format($data['unit_cost']);
    //         $data['imtiyaz_discount'] = number_format($data['imtiyaz_discount']);
    ...
    //     $footer['tax_amount'] = number_format($footer['tax_amount']);
    //     $footer['cost_of_sale'] = number_format($footer['cost_of_sale']);
    //     $footer['unit_cost'] = number_format($footer['unit_cost']);
    //     $footer['imtiyaz_discount'] = number_format($footer['imtiyaz_discount']);
