...
class DailyAdmitsByTypeReport extends DefaultReport
{
    ...
    public $label = "Daily Admits By Type";
    ...
    public function rows()
    {
        ...
        $last_week_booked_seats_admits = OrderSeat::with('zone')
            ->select(DB::raw('zone_id as identifier'), DB::raw('COUNT(*) as count'))
            ...
            ->select(DB::raw('zone_id as identifier'), DB::raw('SUM(price) as count'))
        ...
        $booked_seats = OrderSeat::with('zone')
            ->select("order_seats.*", "zone_id as identifier")
