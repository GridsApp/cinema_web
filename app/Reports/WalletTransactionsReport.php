...
class WalletTransactionsReport extends DefaultReport
{
    ...
    public function filters()
    {
        ...
        $this->addFilter('filter_payment_reference');
    }
    ...
    public function header()
    {
        ...
        $this->addColumn("payment_method", "Order Payment Method");
    }
    ...
    public function rows()
    {
        ...
        $baseQuery = DB::table('user_wallet_transactions')
            ->leftJoin('users as customers', 'user_wallet_transactions.user_id', '=', 'customers.id')
            ->join('orders', 'user_wallet_transactions.reference', '=', 'orders.id')
            ...
            ->select([
                ...
                'user_wallet_transactions.type',
                'user_wallet_transactions.amount',
