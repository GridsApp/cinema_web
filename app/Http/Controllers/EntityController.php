...
class EntityController extends Controller
{
    public function render($slug)
    {
        ...
        // $content = file_get_contents("https://lh3.googleusercontent.com/a/ACg8ocKwHYHryzZojoFjk5DuZqBcH94v8KBjm7EqiOOFscs1aSinJ-eIWg=s1337");


        // $url = Storage::put("/img/charbel.jpg" , $content);


        $entity = get_entity($slug);
        $path = $entity->render ? $entity->render : 'pages.entity.index';
    ...
    public function create($slug)
    {
        ...
        $path = $entity->form ? $entity->form : 'pages.form.index';
