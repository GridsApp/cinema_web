{{-- <div x-data="{
    selectedDate: new URLSearchParams(window.location.search).get('date') || '{{ $selectedDate }}',
    selectedTime: new URLSearchParams(window.location.search).get('time') || '{{ $selectedTime }}',
    movieShowId: '',
    selectedShowId: '',
                            ...
                            <div class="timing-list">
                                @foreach ($shows as $show)
                                 ...
                                 <div class="flex justify-center active-color bg-gray-100 gap-3 items-center rounded-full pr-5">
                                     ...
                                     <span class="text-[10px] active tracking-[1.9px] font-bold">
                                         {{ $show['time'] }}
                                     </span>
                                 </div>
                             </div>
