<div x-data="{ expanded: false }">
    ...
    <div id="available-times" class="available-times mt-05 mb-20">
        ...
        <div class="theater-data-container">
            <h2 class="theater-name">web Prefix Branch</h2>

            <div class="zone">Price Group</div>
            <div class="timing-list">
                ...
                <div class="time-button">
                    <div class="flex justify-center bg-gray-100 gap-3 items-center rounded-full py-1 pl-1 pr-5">
                        ...
                        <span class="text-[10px] tracking-[1.9px] font-bold">12:00</span>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <button @click="expanded = !expanded"
            class="primary-color text-[12px] uppercase underline font-bold px-4 py-2 rounded-full mt-4 transition">
