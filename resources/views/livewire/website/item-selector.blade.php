...
<button type="button" 
    class="px-3 py-1 text-[20px] primary-color font-bold rounded-l-md" 
...
<input type="number" 
    x-model="quantity" 
    class="w-12 text-center font-bold border-x border-transparent outline-none" 
    min="0">



<button type="button" 
    class="px-3 py-1 text-[20px] primary-color font-bold rounded-r-md" 
    @click="quantity++"
