    ...
    <div class="flex sm:flex-row flex-col sm:gap-10 gap-5 filteration">
        <div class="w-full flex flex-row sm:gap-6 gap-4" class="filteration-select">
            <div class="sm:w-fit w-full">
                <select wire:change="filterMovies" wire:model="selectedBranch" class="custom-select lg:w-[400px] md:w-[400px] sm:w-full font-bold uppercase">
            ...
            <button type="button" wire:click="filterMovies">
                <svg xmlns="http://www.w3.org/2000/svg" width="22.02" height="22.02" viewBox="0 0 22.02 22.02">
                    <g id="Icon_feather-search" data-name="Icon feather-search" transform="translate(1.5 1.5)">
                        <path id="Path_845" data-name="Path 845" d="M20.855,12.677A8.177,8.177,0,1,1,12.677,4.5a8.177,8.177,0,0,1,8.177,8.177Z"
                            transform="translate(-4.5 -4.5)" fill="none" stroke="#c51a24" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path>
                        <path id="Path_846" data-name="Path 846" d="M29.421,29.421l-4.446-4.446"
                            transform="translate(-11.022 -11.022)" fill="none" stroke="#c51a24" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path>
                    </g>
                </svg>
            </button>
        </div>
