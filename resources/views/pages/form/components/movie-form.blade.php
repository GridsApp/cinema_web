                    ...
                    @component('CMSView::components.panels.default', ['title' => 'Fetch Record'])
                        <div class="grid grid-cols-12 gap-5 ">
                            ...
                            <div class="col-span-1">
                                ...
                                <button wire:loading.class="opacity-50" class="btn btn-primary" type="button"
                                    wire:click="handleFetch">
                                    Fetch
                                </button>
                            </div>
                            <div class="col-span-2">
                                <div style="min-height: 27.5px"></div>
                                <button class="btn btn-secondary" wire:loading.class="opacity-50" type="button"
